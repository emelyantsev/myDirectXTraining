...
void TreeBillboardsApp::OnKeyboardInput()
{
}
 
void TreeBillboardsApp::UpdateCamera()
{
...
void TreeBillboardsApp::AnimateMaterials()
{
...
void TreeBillboardsApp::UpdateObjectCBs()
{
...
void TreeBillboardsApp::UpdateMaterialCBs()
{
...
void TreeBillboardsApp::UpdateMainPassCB()
{
...
void TreeBillboardsApp::BuildRenderItems()
{
	...
	DirectX::XMStoreFloat4x4(&wavesRitem->TexTransform, XMMatrixScaling(5.0f, 5.0f, 1.0f));
	...
	DirectX::XMStoreFloat4x4(&gridRitem->TexTransform, XMMatrixScaling(5.0f, 5.0f, 1.0f));
	...
	DirectX::XMStoreFloat4x4( &boxRitem->World, XMMatrixTranslation(3.0f, 2.0f, -9.0f) );
