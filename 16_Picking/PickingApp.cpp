...
void PickingApp::OnKeyboardInput()
{
...
void PickingApp::AnimateMaterials()
{
	
}

void PickingApp::UpdateObjectCBs()
{
...
void PickingApp::UpdateMaterialBuffer()
{
...
void PickingApp::UpdateMainPassCB()
{
...
void PickingApp::BuildMaterials()
{
	...
	highlight0->DiffuseAlbedo = XMFLOAT4(0.5f, 1.0f, 0.0f, 0.6f);
