...
void LitColumnsApp::OnKeyboardInput()
{
}
 
void LitColumnsApp::UpdateCamera()
{
...
void LitColumnsApp::AnimateMaterials()
{
	
}

void LitColumnsApp::UpdateObjectCBs()
{
...
void LitColumnsApp::UpdateMaterialCBs()
{
...
void LitColumnsApp::UpdateMainPassCB()
{
	...
	mMainPassCB.Lights[0].Direction = {0.0f, -1.0f, 0.0f} ;    //{ 0.57735f, -0.57735f, 0.57735f };
	mMainPassCB.Lights[0].Strength = {0.0f, 0.0f, 0.0f} ; // { 0.6f, 0.6f, 0.6f };
	mMainPassCB.Lights[1].Direction = { -0.57735f, -0.57735f, 0.57735f };
	mMainPassCB.Lights[1].Strength = {0.0f, 0.0f, 0.0f} ;//{ 0.3f, 0.3f, 0.3f };
	mMainPassCB.Lights[2].Direction = { 0.0f, -0.707f, -0.707f };
	mMainPassCB.Lights[2].Strength = {0.0f, 0.0f, 0.0f} ;//{ 0.15f, 0.15f, 0.15f };

	mMainPassCB.Lights[3].Direction = {0.0f, -1.0f, 0.0f} ;    //{ 0.57735f, -0.57735f, 0.57735f };
	mMainPassCB.Lights[3].Strength = {0.0f, 0.0f, 0.0f} ;
	mMainPassCB.Lights[3].Position = {0.0f, 5.0f, -5.0f} ;
	mMainPassCB.Lights[3].FalloffStart = 1.0f;
	mMainPassCB.Lights[3].FalloffEnd = 10.0f;

	mMainPassCB.Lights[4].Direction = {0.57735f, -0.57735f, 0.57735f} ;    //{ 0.57735f, -0.57735f, 0.57735f };
	mMainPassCB.Lights[4].Strength = {0.6f, 0.6f, 0.6f} ;
	mMainPassCB.Lights[4].Position = {-4.0f, 5.0f, -5.0f} ;
	mMainPassCB.Lights[4].FalloffStart = 1.0f;
	mMainPassCB.Lights[4].FalloffEnd = 100.0f;
	mMainPassCB.Lights[4].SpotPower = 2.8f;
