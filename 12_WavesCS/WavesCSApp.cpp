...
void WavesCSApp::OnKeyboardInput()
{
}
 
void WavesCSApp::UpdateCamera()
{
...
void WavesCSApp::AnimateMaterials()
{
...
void WavesCSApp::UpdateObjectCBs()
{
...
void WavesCSApp::UpdateMaterialCBs()
{
...
void WavesCSApp::UpdateMainPassCB()
{
...
void WavesCSApp::UpdateWavesGPU()
{
	...
	mWaves->Update(mTimer, mCommandList.Get(), mWavesRootSignature.Get(), mPSOs["wavesUpdate"].Get());
}
